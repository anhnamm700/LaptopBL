...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Danh Sách Tài Khoản MOD</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php?page=AddAccount">Thêm tài khoản</a></li>
              <li class="breadcrumb-item"><a href="index.php?page=CustomersList">Tài khoản Customers</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="col-sm-12">
      <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
               ...
               <?php
               $i = 1;
               $sqlGetAcc = mysqli_query($conn, "SELECT * FROM account INNER JOIN authorities ON account.AuthoritiesID = authorities.AuthoritiesID WHERE account.AuthoritiesID = 3");
                $data = [];
