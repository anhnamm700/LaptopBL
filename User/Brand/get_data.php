<?php
    ...
    if (isset($_POST['action'])) {
        ...
        $query = "SELECT * FROM products INNER JOIN brand ON products.BrandID = brand.BrandID WHERE BrandName LIKE '$name' ";
        ...
        if (isset($_POST['minimum_price']) != null && isset($_POST['medium_price']) == null && isset($_POST['max_price']) == null) {
            $query .= "AND products.Total BETWEEN 5000000 and 20000000"; 
        } 

        if (isset($_POST['minimum_price']) == null && isset($_POST['medium_price']) != null && isset($_POST['max_price']) == null) {
            $query .= "AND products.Total BETWEEN 21000000 and 40000000";
        }
        
        if (isset($_POST['minimum_price']) != null && isset($_POST['medium_price']) != null && isset($_POST['max_price']) == null) {
            $query .= "AND products.Total BETWEEN 5000000 and 40000000";
        } 

        if (isset($_POST['minimum_price']) == null && isset($_POST['medium_price']) != null && isset($_POST['max_price']) != null) {
            $query .= "AND products.Total > 21000000";
        }

        if (isset($_POST['minimum_price']) == null && isset($_POST['medium_price']) == null && isset($_POST['max_price']) != null) {
            $query .= "AND products.Total > 41000000";
        }

        
        if (isset($_POST['minimum_price']) != null && isset($_POST['medium_price']) != null && isset($_POST['max_price']) != null) {
            $query .= "AND products.Total BETWEEN 5000000 and 100000000";
        }
                ...
                <li class="col-sx-12 col-sm-4">
                    <div class="product-container">
                        ...
                        <div class="right-block">
                            ...
                            .(($row['4'] > 0) ? '<span class="price product-price">'.number_format($row['5'], 0, '', ',').'đ'.'</span><span class="price old-price">'.number_format($row['3'], 0, '', ',').'đ'.'</span>' : '<span class="price product-price">'.number_format($result, 0, '', ',').'đ'.'</span>').
                            '</div>
